...
let spacecraftName: string = "Determination"; //comment out for part 4
let speedMph: number = 17500; //comment out for part 4
let kilometersToMars: number = 225000000;
let kilometersToTheMoon: number = 384400;
let milesPerKilometer: number = 0.621; //comment out for part 4
